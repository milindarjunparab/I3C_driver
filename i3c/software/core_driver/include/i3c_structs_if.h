...
struct I3C_SlaveInterruptConfig_s
{
    ...
    bool ibiNack;
    /** If mrDone interrupt should be enabled. */
    bool mrDone;
    ...
    bool testMode;
    /** If defslvs interrupt should be enabled */
    bool defslvs;
    /** If ibid_thr interrupt should be enabled */
    bool ibid_thr;
    /** If mwl_up interrupt should be enabled */
    bool mwl_up;
    /** If mrl_up interrupt should be enabled */
    bool mrl_up;
    /** If resetDaa interrupt should be enabled */
    bool resetDaa;
    /** If buscon_up interrupt should be enabled */
    bool buscon_up;
    /** If flush interrupt should be enabled */
    bool flush_done;
};
...
struct I3C_Callbacks_s
{
    ...
    /** This function will be called when SDR Write is completed and master operates in slave mode. */
    I3C_InterruptEvent slaveSdrWrComplete;
    /** This function will be called when SDR Read is completed and master operates in slave mode. */
    I3C_InterruptEvent slaveSdrRdComplete;
    /** This function will be called when DDR Write is completed and master operates in slave mode. */
    I3C_InterruptEvent slaveDdrWrComplete;
    /** This function will be called when DDR Read is completed and master operates in slave mode. */
    I3C_InterruptEvent slaveDdrRdComplete;
    /** This function will be called when IBI request done is detected and master operates in slave mode. */
    I3C_InterruptEvent slaveIBIDone;
    /** This function will be called when SDR error is detected and master operates in slave mode. */
    I3C_InterruptEvent slaveSdrError;
    /** This function will be called when TestMode command arrives. */
    I3C_InterruptEvent testMode;
    /** This function will be called when SETMWL CCC command arrives. */
    I3C_InterruptEvent slaveMwlChange;
    /** This function will be called when SETMRL CCC command arrives. */
    I3C_InterruptEvent slaveMrlChange;
    /** This function will be called when RSTDAA CCC command arrives. */
    I3C_InterruptEvent slaveResetDaa;
    /** This function will be called when SETBUSCON CCC command arrives. */
    I3C_InterruptEvent slaveBusconUp;
    /** This function will be called when flushing of SDR RX/TX is done. */
    I3C_InterruptEvent slaveFlushDone;
};
...
struct I3C_PrivData_s
{
    ...
    uint16_t hj_devices;
    /** permissible max count of ibi payload. */
    uint16_t max_ibi_payload_size;
    /** permissible max count of user purpose regs accessible through apb. */
    uint16_t num_apb_rw_csrs;
    /** permissible max count of user purpose regs accessible through apb. */
    uint16_t num_apb_ro_csrs;
    /** permissible max count of user gpi. */
    uint16_t num_gpi_csrs;
    /** permissible max count of user gpo. */
    uint16_t num_gpo_csrs;
};
...
struct I3C_Tcam0Data_s
{
    /** Supported Mode Bytes */
    ...
    uint8_t freqByte;
    /** Inaccuracy Byte. */
    uint8_t InaccuracyByte;
};

/** Structure for holding details of perticular Group. */
struct I3C_GroupDescriptors_s
{
    /** group address */
    uint8_t group_address;
    /** Identifier of this group */
    uint8_t group_descriptor;
    /** Number of targets. */
    uint8_t target_count;
    /** dyanamic address of targets */
    uint8_t da[I3C_ABSOLUTE_MAX_DEVS_NUM];
};
