...
/* 0 - Not Capable */
/* 1 - Capable */
/* parasoft-begin-suppress MISRA2012-RULE-1_1_b_c90-2 "too long name, DRV-5444" */
...
static inline uint8_t i3c_ddr_calc_crc_5(uint8_t icrcIn, uint16_t data_word)
{
    ...
    for (i = 0; i < 16U; ++i) {
        /* parasoft-begin-suppress MISRA2012-RULE-12_2-2 The right-hand operation of a shift operator */
        /* shall lie on the range zero to one less than the width in bits of the essential type of the */
        /* left-hand operand, DRV-5443 */
        /* RHS operand of shift will always be less than 16 */
...
/* Returns define byte to be transmitted */
static inline uint64_t i3c_cmd_get_define_byte_value(uint8_t value) {
    return (((uint64_t)((value) & 0xFFU)) << 40U);
}
#ifdef __cplusplus
}
#endif
